...
Grupo | Validador | Validaci&oacute;n
------------ | ----------------- | -----------------
...
public class Student {
    ...
    public List<ConstraintViolation> validateBeforeInsert() {
        return new Validator("student")
                .stringField(this::getFirstName, "first name")
                    .notBlank()
                    .minLength(3)
                    .maxLength(50)
                .stringField(this::getLastName, "last name")
                    .notBlank()
                    .minLength(3)
                    .maxLength(50)
                .stringField(this::getGender, "gender")
                    .notNull()
                    .values(Gender.class)
                .numberField(this::getAge, "age")
                    .notNull()
                    .min(0)
                    .max(150)
                .dateField(this::getCreatedOn, "created on")
                    .notNull()
                    .pastOrPresent()
                .dateField(this::getUpdatedOn, "updated on")
                    .alwaysNull()
                .validate();
    }
}
